...
internal class AssetHoldingRepositoryImpl(
    ...
    override suspend fun upsert(model: AssetHolding) =
        dataSource.save(model)

    override suspend fun getById(id: Long): AssetHolding =
        dataSource.getById(id)

    override suspend fun getAll() =
        dataSource.getAll()

    override suspend fun getByAssetId(assetId: Long) =
        dataSource.getByAssetId(assetId)
