...
internal class AssetInMemoryDataSourceImpl : AssetInMemoryDataSource {
    ...
    override fun getAll(): List<Asset> = buildList {
        ...
        VI("RBRR11", "RBRR11", REAL_ESTATE_FUND, "RBRR11")
        VI("XPML11", "XPML11", REAL_ESTATE_FUND, "XPML11")
        VI("MCCI11", "MCCI11", REAL_ESTATE_FUND, "MCCI11")
        VI("KNCR11", "KNCR11", REAL_ESTATE_FUND, "KNCR11")
        VI("RCRB11", "RCRB11", REAL_ESTATE_FUND, "RCRB11")
        VI("BRCO11", "BRCO11", REAL_ESTATE_FUND, "BRCO11")
        VI("TEPP11", "TEPP11", REAL_ESTATE_FUND, "TEPP11")
        VI("HGCR11", "HGCR11", REAL_ESTATE_FUND, "HGCR11")
        VI("TRBL11", "TRBL11", REAL_ESTATE_FUND, "TRBL11")
        VI("MCRE11", "MCRE11", REAL_ESTATE_FUND, "MCRE11")
        VI("BTHF11", "BTHF11", REAL_ESTATE_FUND, "BTHF11")
        VI("HSML11", "HSML11", REAL_ESTATE_FUND, "HSML11")
        VI("HFOF11", "HFOF11", REAL_ESTATE_FUND, "HFOF11")
        VI("AJFI11", "AJFI11", REAL_ESTATE_FUND, "AJFI11")
        VI("HGLG11", "HGLG11", REAL_ESTATE_FUND, "HGLG11")
        VI("VISC11", "VISC11", REAL_ESTATE_FUND, "VISC11")
        VI("ALZR11", "ALZR11", REAL_ESTATE_FUND, "ALZR11")
        VI("CLIN11", "CLIN11", REAL_ESTATE_FUND, "CLIN11")
        VI("RBRF11", "RBRF11", REAL_ESTATE_FUND, "RBRF11")
        VI("PSEC11", "PSEC11", REAL_ESTATE_FUND, "PSEC11")
        VI("PVBI11", "PVBI11", REAL_ESTATE_FUND, "PVBI11")
        VI("BTLG11", "BTLG11", REAL_ESTATE_FUND, "BTLG11")
        VI("HGPO11", "HGPO11", REAL_ESTATE_FUND, "HGPO11")
        VI("WHGR11", "WHGR11", REAL_ESTATE_FUND, "WHGR11")
    }
