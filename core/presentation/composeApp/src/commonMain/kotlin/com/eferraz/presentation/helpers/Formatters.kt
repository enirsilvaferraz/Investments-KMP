...
internal object Formatters {
    ...
    internal fun Asset.formated(): String =
        when (this) {
    ...
    internal fun FixedIncomeAssetType.formated() =
        when (this) {
    ...
    internal fun FixedIncomeSubType.formated() =
        when (this) {
    ...
    internal fun InvestmentFundAssetType.formated() =
        when (this) {
    ...
    internal fun VariableIncomeAssetType.formated() =
        when (this) {
